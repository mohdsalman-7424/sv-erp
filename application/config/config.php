...
if (!function_exists('core_url')) {
    function core_url($atRoot = FALSE, $atCore = FALSE, $parse = FALSE)
    {
        ...
        if ($_SERVER['SERVER_PORT'] == '443') {
            ...
            //return '192.168.1.9/g-m/';
            // return 'http://192.168.1.9/raprocure/';
        }
...
//$config['cache_path'] = '/home/freshngr/cache/' ;
$config['cache_path'] = FCPATH . 'cache' . DIRECTORY_SEPARATOR;
...
//$login_ip = $_SERVER['HTTP_CLIENT_IP']?$_SERVER['HTTP_CLIENT_IP']:($_SERVER['HTTP_X_FORWARDE‌​D_FOR']?$_SERVER['HTTP_X_FORWARDED_FOR']:$_SERVER['REMOTE_ADDR']);
...
// Hardcoded base URL — always points to /sv_erp/ subfolder
$config['base_url'] = 'http://' . $_SERVER['HTTP_HOST'] . '/sv_erp/';
