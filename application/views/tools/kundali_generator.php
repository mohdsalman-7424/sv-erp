...
<section class="section" style="background:var(--bg-primary)">
	<div class="container" style="max-width:960px">
      ...
      <div class="sec-label">✦ Sacred Vedic Tool</div>
      <h1 class="cinzel" style="color:var(--navy);font-size:clamp(28px,5vw,44px);margin-bottom:12px">Generate Your Janam Kundli</h1>
      <p style="color:var(--text-mid);font-size:16px;max-width:600px;margin:0 auto">Enter your birth details for a personalized Vedic birth chart.</p>
    </div>
		...
		<div class="form-card" style="max-width:860px;margin:0 auto 32px">
			<div style="display:flex;align-items:center;gap:12px;margin-bottom:22px;padding-bottom:18px;border-bottom:1px solid var(--border)">
				...
				<div>
					<h3 class="cinzel" style="font-size:18px;color:var(--navy)" data-theme-text>Birth Information</h3>
					<p style="font-size:12px;color:var(--text-muted)">All fields required for accurate Kundali generation</p>
				</div>
			</div>
			<div class="form-grid-2">
				<div class="form-group"><label class="form-label">Full Name <span class="req">*</span></label>
					<div class="input-wrap"><span class="input-icon">👤</span><input class="form-input" type="text" id="kName" placeholder="e.g. Rahul Kumar Sharma" value="Arjun Kumar Mehta"></div>
				</div>
				<div class="form-group"><label class="form-label">Gender <span class="req">*</span></label><select class="form-select" id="kGender">
						<option>Male</option>
						<option>Female</option>
						<option>Other</option>
					</select></div>
				<div class="form-group"><label class="form-label">Date of Birth <span class="req">*</span></label>
					<div class="input-wrap"><span class="input-icon">📅</span><input class="form-input" type="date" id="kDOB" value="1995-05-15"></div>
				</div>
				<div class="form-group"><label class="form-label">Time of Birth <span class="req">*</span></label>
					<div class="input-wrap"><span class="input-icon">🕐</span><input class="form-input" type="time" id="kTOB" value="06:30"></div>
				</div>
				...
				<div class="form-group"><label class="form-label">State</label><select class="form-select">
				...
				<div class="form-group full"><label class="form-label">City of Birth <span class="req">*</span></label>
					<div class="input-wrap"><span class="input-icon">📍</span><input class="form-input" type="text" id="kCity" placeholder="e.g. Varanasi, Mumbai, Delhi..." value="Varanasi"></div>
				</div>
				<div class="form-group"><label class="form-label">Chart Style</label><select class="form-select">
						<option>North Indian</option>
						<option>South Indian</option>
					</select></div>
				<div class="form-group"><label class="form-label">Language</label><select class="form-select">
		...
		<div id="kundliResult" style="display:none;max-width:860px;margin:0 auto">
			<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:18px;flex-wrap:wrap;gap:12px">
				<div>
					<h3 class="playfair" style="font-size:22px;color:var(--navy)" data-theme-text>Kundali of <em id="rName"></em></h3>
					<p style="font-size:12px;color:var(--text-muted)" id="rSub"></p>
				</div>
			...
			<div class="grid-2" style="gap:20px;margin-bottom:18px" id="kundliResGrid">
				<!-- Chart -->
				...
				<div>
					...
					<div class="form-card" style="padding:18px">
						...
						<div class="dasha-row">
							<div class="dasha-dot" style="background:rgba(255,200,0,0.15);color:#FFD700">Su</div>
							<div style="flex:1">
								<div style="font-size:12px;font-weight:700;color:var(--navy)">Sun Mahadasha (Current)</div>
								<div style="font-size:11px;color:var(--text-muted)">Jun 2024 – Jun 2030</div>
							</div>
							<div class="dasha-bar-wrap">
								<div class="dasha-bar" style="width:30%"></div>
							</div>
						</div>
						<div class="dasha-row">
							<div class="dasha-dot" style="background:rgba(180,180,255,0.15);color:#C0C0FF">Mo</div>
							<div style="flex:1">
								<div style="font-size:12px;font-weight:700;color:var(--navy)">Moon Mahadasha</div>
								<div style="font-size:11px;color:var(--text-muted)">Jun 2030 – Jun 2040</div>
							</div>
							<div class="dasha-bar-wrap">
								<div class="dasha-bar" style="width:0%"></div>
							</div>
						</div>
			...
			<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:18px">
				<div class="form-card" style="padding:16px">
					...
					<div class="cinzel" style="font-size:12px;font-weight:700;color:var(--navy);margin-bottom:6px">Career Outlook</div>
					<p style="font-size:12px;color:var(--text-muted);line-height:1.6">Strong 2nd house Jupiter indicates wealth through knowledge. Teaching, consulting, or law are favorable paths.</p>
				</div>
				<div class="form-card" style="padding:16px">
					<div style="font-size:24px;margin-bottom:8px">💑</div>
					<div class="cinzel" style="font-size:12px;font-weight:700;color:var(--navy);margin-bottom:6px">Marriage Prospects</div>
					<p style="font-size:12px;color:var(--text-muted);line-height:1.6">7th house Moon in Leo suggests a passionate partner. Marriage likely 28–32. Not Manglik. ✓</p>
				</div>
				<div class="form-card" style="padding:16px">
					<div style="font-size:24px;margin-bottom:8px">💊</div>
					<div class="cinzel" style="font-size:12px;font-weight:700;color:var(--navy);margin-bottom:6px">Health Guidance</div>
					<p style="font-size:12px;color:var(--text-muted);line-height:1.6">Saturn in 1st house — attention to bones and joints. Regular yoga and pranayama are recommended.</p>
				</div>
			</div>
			...
			<div style="background:var(--gold-pale);border:1px solid var(--border);border-radius:var(--r);padding:16px;display:flex;gap:13px;align-items:flex-start;flex-wrap:wrap">
				...
				<div style="flex:1;min-width:180px">
					<div style="font-weight:700;color:var(--navy);margin-bottom:4px;font-size:13px">AI-Generated Draft — Professional Review Recommended</div>
					<p style="font-size:12px;color:var(--text-muted);line-height:1.6">These are AI-assisted preliminary observations. For accurate, personalized predictions consult a verified Vedic astrologer.</p><a href="<?= site_url('astrologers') ?>" class="btn btn-primary btn-sm" style="margin-top:10px;display:inline-flex">Book Expert Consultation →</a>
				</div>
			</div>
		</div>
 </div>
		...
		<script>
			function generateKundali() {
				...
				document.getElementById('kundliResult').scrollIntoView({
					behavior: 'smooth',
					block: 'start'
				});
